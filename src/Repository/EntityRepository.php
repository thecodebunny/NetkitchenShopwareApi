...
use Thecodebunny\ShopwareApi\Data\StagingContext;
...
class EntityRepository implements RepositoryInterface
{
     ...
     * Create an entity
     */
    public function create(array $data, Context|MediaImportContext|MediaUploadContext|ProductUploadContext|MediaUploadFilesContext|CustomerImportContext|StockUpdateContext|PriceUpdateContext|KueblerContext|DewaltContext|BrilliantContext|HerthContext|MilwaukeeContext|UvexContext|StagingContext $context)
    {
		try {
     ...
     * Update an entity
     */
    public function update(array $data, Context|MediaImportContext|MediaUploadContext|ProductUploadContext|MediaUploadFilesContext|CustomerImportContext|StockUpdateContext|PriceUpdateContext|KueblerContext|DewaltContext|BrilliantContext|HerthContext|MilwaukeeContext|UvexContext|StagingContext $context)
    {
        //dump($data);
        if (empty($data['id'])) {
	...
	public function updateOrderTransactionState(array $data, $transition,Context|MediaImportContext|MediaUploadContext|ProductUploadContext|MediaUploadFilesContext|CustomerImportContext|StockUpdateContext|PriceUpdateContext|KueblerContext|DewaltContext|BrilliantContext|HerthContext|MilwaukeeContext|UvexContext|StagingContext $context)
	{
		if (empty($data['id'])) {
			return new \InvalidArgumentException('Id is not provided for update payload');
		}
		...
		$id = $data['id'];
		try {
			return $this->httpClient->post($this->getEntityOrderTransactionStateEndpoint($context->apiEndpoint, $id,
				$transition), [
				'headers' => $this->buildHeaders($context),
				'body' => json_encode($data)
			])->getBody()->getContents();
    ...
    public function updateBulk(array $data, Context|MediaImportContext|MediaUploadContext|ProductUploadContext|MediaUploadFilesContext|CustomerImportContext|StockUpdateContext|PriceUpdateContext|KueblerContext|DewaltContext|BrilliantContext|HerthContext|MilwaukeeContext|UvexContext|StagingContext $context)
    {
        try {
	...
	public function movePickwareStock(array $data, Context|MediaImportContext|MediaUploadContext|ProductUploadContext|MediaUploadFilesContext|CustomerImportContext|StockUpdateContext|PriceUpdateContext|KueblerContext|DewaltContext|BrilliantContext|HerthContext|MilwaukeeContext|UvexContext|StagingContext $context)
	{
...
//			Log::channel('$exception')->info('$response - ' . print_r($exception, true));
			throw new ShopwareResponseException($exception->getResponse()->getBody()->getContents(), $exception->getResponse()->getStatusCode(), $exception);
		}
	}

    public function delete(string $id, Context|MediaImportContext|MediaUploadContext|ProductUploadContext|MediaUploadFilesContext|CustomerImportContext|StockUpdateContext|PriceUpdateContext|KueblerContext|DewaltContext|BrilliantContext|HerthContext|MilwaukeeContext|UvexContext|StagingContext $context)
    {
        try {
    ...
    public function syncDeleted(array $ids, Context|MediaImportContext|MediaUploadContext|ProductUploadContext|MediaUploadFilesContext|CustomerImportContext|StockUpdateContext|PriceUpdateContext|KueblerContext|DewaltContext|BrilliantContext|HerthContext|MilwaukeeContext|UvexContext|StagingContext $context): ApiResponse
    {
    ...
    public function createVersion(string $id, Context|MediaImportContext|MediaUploadContext|ProductUploadContext|MediaUploadFilesContext|CustomerImportContext|StockUpdateContext|PriceUpdateContext|KueblerContext|DewaltContext|BrilliantContext|HerthContext|MilwaukeeContext|UvexContext|StagingContext $context, ?string $versionId = null, ?string $versionName = null): VersionResponse
    {
        $data = [];
    ...
    public function mergeVersion(string $versionId, Context|MediaImportContext|MediaUploadContext|ProductUploadContext|MediaUploadFilesContext|CustomerImportContext|StockUpdateContext|PriceUpdateContext|KueblerContext|DewaltContext|BrilliantContext|HerthContext|MilwaukeeContext|UvexContext|StagingContext $context): void
    {
        try {
    ...
    public function clone(string $id, Context|MediaImportContext|MediaUploadContext|ProductUploadContext|MediaUploadFilesContext|CustomerImportContext|StockUpdateContext|PriceUpdateContext|KueblerContext|DewaltContext|BrilliantContext|HerthContext|MilwaukeeContext|UvexContext|StagingContext $context, ?CloneBehaviour $cloneBehaviour = null): string
    {
        $data = [];
	...
	string
	{
		return sprintf('%s/api/_action%s/%s/state/%s?_response=detail', $endpoint, $this->route, $entityId ??
			'', $transition ??
		'');
	}

	protected function getEntityOrderTransactionStateEndpoint(string $endpoint, ?string $entityId = null, ?string
	$transition =
	null):
	string
	{
		return sprintf('%s/api/_action%s/%s/state/%s?_response=detail', $endpoint, '/order_transaction', $entityId ??
			'', $transition ??
			'');
	}
